...
namespace FinancialCalculator.Stores
{
    internal class BudgetStore
    {
        ...
        public BudgetStore()
        {
            ...
            Budgets.Add(1, new FixedBudget(1, "Investments", postTax, false, setPct: 0.6f));
            Budgets.Add(2, new FixedBudget(2, "401K", preTax, false, setPct: 0.1f));
            Budgets.Add(3, new FixedBudget(3, "Roth IRA", postTax, false, setPct: 0.1f));
            ...
            Budgets.Add(10, new FixedBudget(10, "Savings", postTax, false, setPct: 0.2f));
